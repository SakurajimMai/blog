---
title: DNS振り分けによるストリーミングサービスの制限解除
date: 2024/12/25
tags:
  - リナックス
  - ドメインネームシステム
...
permalink: /ja/blog/yix3isi9/
---
まず、太っ腹な[Alice](https://app.alice.ws/streaming/console)が提供する無料のDNSサービスに感謝します。個人ユーザーは無料でIPを5個追加でき、ストリーミングやAIサービスのアンロックに利用できます。
...
![図1](https://s2.ixacg.com/2025/04/10/1744271785.avif "図1")​

図1のとおりに設定するだけでアンロックできます。必要なドメインは必要に応じて追加してください。
...
### 1.なぜストリーミングにアクセスできないのですか？

通常、AliceでIPを追加した後はホワイトリストの反映が必要で、24時間後には対象地域へ正常にアクセスしてアンロックできるようになります。
