...
const zhToolDoc = defineCollection({
  // doc 类型，该类型带有侧边栏
  type: 'doc',
  // 文档集合所在目录，相对于 `docs/`
  dir: 'tools',
...
const enToolDoc = defineCollection({
  // doc 类型，该类型带有侧边栏
  type: 'doc',
  // 文档集合所在目录，相对于 `docs/`
  dir: 'tools',
...
const jaDemoDoc = defineCollection({
  // doc 类型，该类型带有侧边栏
  type: 'doc',
  // 文档集合所在目录，相对于 `docs/en/`
  dir: 'demo',
...
const jaToolDoc = defineCollection({
  // doc 类型，该类型带有侧边栏
  type: 'doc',
  // 文档集合所在目录，相对于 `docs/`
  dir: 'tools',
 ...
 *  (enDemoDoc 为参考示例，如果不需要它，请删除)
 */
export const jaCollections = defineCollections([
  jaBlog,
  jaDemoDoc,
  jaToolDoc,
])