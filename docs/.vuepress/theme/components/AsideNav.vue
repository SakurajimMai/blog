...
const locales: Record<string, Locale> = {
  ...
  '/ja/': { star: 'GitHubでスター', issue: '問題が発生しました', sponsor: 'バブルティーを買ってください' },
}
...
<template>
  <div class="aside-nav-wrapper">
    <VPLink class="link" no-icon href="https://github.com/SakurajimMai">
    ...
    <VPLink class="link" href="https://ko-fi.com/sakurajiamai">
