---
title: Unlocking Streaming Media with DNS Traffic Splitting
date: 2024/12/25
tags:
  - Linux
  - DNS
cover: https://s2.ixacg.com/2025/04/10/1744271760.avif
createTime: 2026/01/06 11:47:22
permalink: /en/blog/yix3isi9/
---
First, thanks to [Alice](https://app.alice.ws/streaming/console) for providing the free DNS service. Individual users can add up to 5 IPs for free, which can be used to unlock streaming and AI services.

<!-- more -->

## v2bx DNS Split Routing
...
![Figure 1](https://s2.ixacg.com/2025/04/10/1744271785.avif "Figure 1")​

As shown in Figure 1, configure it like this to unlock. Add required domains as needed.
...
```
        "domains": [
          ...
          "domain:cdn.plyr.io",
          "domain:4gtv.tv",
          "domain:4gtvfreepc-cds.cdn.hinet.net",
          "domain:4gtvfreepcvod-cds.cdn.hinet.net",
          "domain:4gtvpc-cds.cdn.hinet.net",
          "domain:4gtvpcvod-cds.cdn.hinet.net",
...
# > LiTV
"domain:litv.tv",
"domain:litvfreepc.akamaized.net",
# > MyVideo
"domain:cdn.plyr.io",
"domain:myvideo.net.tw",
# > 4GTV
...
"domain:scc.ott.hinet.net",
# > CatchPlay+
"domain:catchplay.com",
"domain:d2ivmxp5z2ww0n.cloudfront.net",
"domain:ols-ww100-cp.akamaized.net",
"domain:tra-www000-cp.akamaized.net",
# > HBO GO Asia
...
# > NBA TV
"domain:nba.com",
"domain:neulion-a.akamaihd.net",
"domain:nlnbamdnyc-a.akamaihd.net",
"domain:sdk.iad-03.braze.com",
"domain:nbaprop.sc.omtrdc.net",
"domain:nlnbaqos.neulion.com",
"domain:watchnba.cdnfastly.endeavorstreaming.net",
"domain:nbaapi.neulion.com",
"domain:nba-api-cdn.opin.media",
"domain:neulionqos-a.akamaihd.net",
"domain:neulion.com",
"domain:nbaprop.tt.omtrdc.net",
"domain:lion-nba-msl.akamaized.net",
"domain:nbanlds19vod.akamaized.net",
# > Acorn TV
"domain:edge.api.brightcove.com",
"domain:api.rlje.net",
"domain:boltdns.net",
...
"domain:sho.com",
"domain:showtime.com",
"domain:showtimeanytime.com",
# > BritBox
"domain:vod-dash-ntham-comm-live.akamaized.net",
"domain:vod-dash-ntham-comm.live.cf.md.bbci.co.uk",
"domain:vod-hls-ntham-comm-live.akamaized.net",
"domain:vod-hls-ntham-comm.live.cf.md.bbci.co.uk",
"domain:britbox.com",
"domain:d2z3p34itxwaj7.cloudfront.net",
# > Funimation
"domain:funimation.com",
"domain:funimationsvc.com",
# > Paramount+
...
"domain:live01-stan.akamaized.net",
"domain:live02-stan.akamaized.net",
# > AU:Binge/Kayo Sports
"domain:kayosports.com.au",
"domain:streamotion.com.au",
# > AU:Docplay
"domain:docplay.com",
"domain:0c86e2d1-madman-com-au.akamaized.net",
"domain:ff1be285-madman-com-au.akamaized.net",
"domain:5a929471-madman-com-au.akamaized.net",
"domain:879ed873-madman-com-au.akamaized.net",
# > AU:7plus
"domain:7plus.com.au",
"domain:npc-live-sevennetwork.akamaized.net",
"domain:7plus-sevennetwork.akamaized.net",
"domain:seven.demdex.net",
"domain:cdn.7livecloud.io",
# > AU:9 now
"domain:nine.com.au",
"domain:9now.com.au",
"domain:edge.api.brightcove.com",
"domain:p-9now.akamaized.net",
"domain:9now-livestreams.akamaized.net",
"domain:9cdn.net",
"domain:9nation.com.au",
"domain:9news.com.au",
"domain:9now.com.au",
"domain:freeviewplus.net.au",
"domain:mi9.com.au",
"domain:mi9cdn.com",
"domain:nine.com.au",
"domain:nineentertainment.com.au",
"domain:nineentertainmentco.com.au",
"domain:ninemediaroom.com.au",
"domain:ninemsn.com.au",
"domain:static9.net.au",
"domain:yourtv.com.au",
# > AU:10 play
"domain:10play.com.au",
"domain:global.ssl.fastly.net",
"domain:airspace-cdn.cbsviedo.com",
"domain:net10-livestream-keys.play.cbsi.video",
"domain:net10-livestream.play.cbsi.video",
"domain:d25m2gzplgnf0.cloudfront.net",
# > AU:ABC iView
"domain:iview.abc.net.au",
"domain:abc-iview-mediapackagestreams-2.akamaized.net",
# > AU:Optus
"domain:optus.com.au",
"domain:optusdigital.com",
"domain:optusnet.com.au",
"domain:optussport.tv",
"domain:optusvideo.tv",
"domain:tls1.yospace.com",
"domain:bln1.yospace.com",
"domain:d3rj5p7u4c4icq.cloudfront.net",
"domain:mgd0ee5iankkv3gidl14rm7c0.litix.io",
"domain:93e30b04-drm-widevine-licensing.axprod.net",
# > AU:SBS on Demand
"domain:sbsod.com",
"domain:sbs.com.au",
"domain:videocdn-sbs.akamaized.net",
"domain:sbsvoddai-vh.akamaihd.net",
"domain:sbsvodns-vh.akamaihd.net",
"domain:sbs-live-dai.akamaized.net",
"domain:sbs-live.akamaized.net",
"domain:sbs-live-dai.akamaized.net",
# > NZ:Neon TV
"domain:neontv.co.nz",
# > NZ:SkyGO NZ
"domain:sky.co.nz",
"domain:prod-skyonelive.akamaized.net",
"domain:skysportnow.co.nz",
"domain:imggaming.com",
"domain:pndsn.com",
# > NZ:ThreeNow
"domain:fullscreen.nz",
# > NZ:Maori TV
#
...
"domain:dtci.co",
"domain:dtci.technology",
"domain:espn.co.uk",
"domain:espn.com",
"domain:espn.net",
"domain:espncdn.com",
"domain:espnqa.com",
"domain:watchespn.com",
# > Epix
"domain:epix.com",
# > Starz
"domain:starz.com",
...
# > A&E TV
"domain:aetv.com",
"domain:ccpa-service.sp-prod.net",
# > NBA TV
"domain:nba.com",
"domain:neulion-a.akamaihd.net",
"domain:nlnbamdnyc-a.akamaihd.net",
...
"domain:peacock.com",
# > Popcornflix
"domain:popcornflix.com",
"domain:popcornflix-prod.cloud.seachange.com",
# > Crunchyroll
...
"domain:funimation.com",
# > EU:SkyShowTime
"domain:skyshowtimeuk.data.adobedc.net",
"domain:skyshowtime.com",
"domain:cssott.com",
"domain:4ac1dd56e493354be504f063e4ae3440a13c6776.cws.conviva.com",
# > EU:HBO Max
"domain:max.com",
"domain:cinemax.com",
...
"domain:maxgo.com",
# > EuroSport
"domain:europe-fastly-mediashield-live-prod.cdn.h264.io",
"domain:akamai.prod-live.h264.io",
"domain:eurosport-dlvr-ott.akamaized.net",
"domain:eu3-prod-images.disco-api.com",
"domain:eu3-prod.disco-api.com",
"domain:eurosportplayer.com",
"domain:eurosport.com",
"domain:eurosport.fr",
"domain:eurosport.es",
"domain:eurosport.ro",
"domain:eurosport.io",
"domain:eurosport.ru",
"domain:media-shield.live.eurosport.map.fastly.net",
"domain:eurosport-dlvr-ott-vod.akamaized.net",
# > ViaPlay
"domain:i-viaplay-com.akamaized.net",
"domain:viaplay.com",
"domain:viaplay.pl",
"domain:mtg-api.com",
# > GB:Sky GO ",SkyGONZ",
...
"domain:zahs.tv",
# > TR:digiturkplay
"domain:digiturkplay.com",
"domain:dt-int-gurme-hls.mncdn.com",
"domain:dt-live-int.akamaized.net",
...
"domain:mewatch.sg",
# > SG:StarHub
"domain:starhubgo.com",
"domain:failoverstarhub.akamaized.net",
"domain:scvm1sc0-ssm.anycast.nagra.com",
"domain:starhubtvplus.com",
# > CatchPlay+
"domain:catchplay.com",
"domain:d2ivmxp5z2ww0n.cloudfront.net",
"domain:ols-ww100-cp.akamaized.net",
...
"domain:trueid.net",
# > TH:AIS Play
"domain:aisplay.ais.co.th",
"domain:ais-vidnt.com",
# > ID:Vidio
"domain:geo-id-media-001-vidio-com.akamaized.net",
# > VN:MYTV
"domain:mytv.vn",
# > VN:Clip TV
"domain:cliptv.vn",
...
"domain:sooka.my",
"domain:kaltura.com",
"domain:1fad96d91f4f519fc79753650a57dad992c44af2.cws.conviva.com",
# > IN:MXPlayer
"domain:mxplayer.in",
# > IN:Tata Play
"domain:tataplay.com",
...
"domain:zee5.com",
# > IN:Jio Cinema
"domain:content-jiovoot.voot.com",
# > UAE:shahid
"domain:mbc.net",
"domain:npaw.com",
"domain:shahid.net",
...
"domain:aianno.cn",
"domain:aianno.com",
"domain:aiqiyicloud-mgmt.com",
"domain:aiqiyicloud.com",
"domain:aiqiyicloud.net",
"domain:baiying.com",
"domain:gitv.cn",
"domain:gitv.tv",
"domain:ibkstore.com",
"domain:iq.com",
"domain:iqiyi.com",
"domain:iqiyi.demo.uwp",
"domain:iqiyiedge.com",
"domain:iqiyiedge.net",
"domain:iqiyipic.com",
"domain:jiangbing.cn",
"domain:pps.tv",
"domain:ppsimg.com",
"domain:ppstream.cn",
"domain:ppstream.com",
"domain:ppstream.com.cn",
"domain:ppstream.net",
"domain:ppstream.net.cn",
"domain:ppsurl.com",
"domain:qiyi.cn",
"domain:qiyi.com",
"domain:qiyipic.com",
...
### 1. Why can’t I access streaming services?

In general, after adding the IP in Alice, it needs to be whitelisted. It should work normally after about 24 hours for region unlocking.