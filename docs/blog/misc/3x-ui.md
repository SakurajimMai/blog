...
像阿里云腾讯云这种服务器就需要关闭防火墙

<!-- more -->

## 连接服务器

使用SSH工具进行连接，例如[termiux](https://termius.com/index.html)

将获取的ip，账号和密码配置后连接服务器.如图所示
...
接下来浏览器打开，输入红框中的URL，登录后进行密码配置即可
...
接下来只需要将刚刚创建的导入客户端就行了，推荐[v2rayNG](https://github.com/2dust/v2rayNG)
